...
function selectCallback(productEl, product, variant, state) {
  ...
  if (variant && variant.available) {
    ...
    //Co-Curator - am. removed from below line: .addClass('disabled').attr('disabled', 'disabled') so "Buy it now" button works all the time
    $('[data-add-to-cart-trigger]', $product).attr('data-options-unselected', null).find('span:not(.icon)').text(message);
