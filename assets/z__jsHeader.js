...
window.PXUTheme.jsHeader = {
  ...
  enableSticky: function(offset) {
    ...
    .on('sticky-start', () => {
      ...
      // Search box height determined bt setting. It was .css('top', totalHeight + 'px') - am
      $stickyEl.parent().parent().find('.search-overlay').addClass('sticky-search').css('top', this.search_height );
